...
class MyPDO extends PDO
{
    ...
    //プロパティ
    private $mode = ''; //実行するSQLの種類
    private $sql = ''; //実行するSQL文
    private $bindArray = array(); //bindValue用の配列
    private $afterBindArray = array(); //複数回SQLを実行する際の、bindValue用の配列
    ...
    public function __construct()
    {
        ...
        $dsn = "pgsql:host={$dbUrl['host']};dbname={$dbName}";
        parent::__construct($dsn, $dbUrl['user'], $dbUrl['pass']);
